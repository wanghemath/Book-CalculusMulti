...
[![Quarto](https://img.shields.io/badge/Built%20with-Quarto-39729E.svg)](https://quarto.org/)
[![Python](https://img.shields.io/badge/Python-Labs-3776AB.svg)](https://www.python.org/)
[![Jupyter](https://img.shields.io/badge/Jupyter-Notebooks-F37626.svg)](https://jupyter.org/)
[![Google Colab](https://img.shields.io/badge/Open%20Labs-Colab-F9AB00.svg)](https://colab.research.google.com/)

**Multivariable Calculus in the Age of Data, AI, and Applied Mathematics** is a modern Quarto textbook designed as a bridge from undergraduate calculus to graduate study in applied mathematics, statistics, data science, artificial intelligence, and machine learning.
